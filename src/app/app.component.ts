...
// (с помощью подходящего хук-метода нужно на основе исходного массива products
// создать новый массив с учетом заданого условия, а также сделать соответсвующий биндинг в шаблоне)
...
// 7. добавить хук-метод ngAfterViewInit(), в котором в консоль вывести оба массива - с продуктами,
// у которых category равен cars и пользователями
